    ...
    return _then(_value.copyWith(
      id: null == id
          ...
          : id // ignore: cast_nullable_to_non_nullable
              as String,
      comrades: null == comrades
          ? _value.comrades
          : comrades // ignore: cast_nullable_to_non_nullable
              as List<String>,
      countryIso3Code: null == countryIso3Code
          ? _value.countryIso3Code
          : countryIso3Code // ignore: cast_nullable_to_non_nullable
              as String,
      date: null == date
          ? _value.date
...
class _$_TravelPlace implements _TravelPlace {
  ...
  @override
  final String id;
  final List<String> _comrades;
  @override
  @JsonKey()
  List<String> get comrades {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.countryIso3Code, countryIso3Code) ||
                other.countryIso3Code == countryIso3Code) &&
  ...
  int get hashCode => Object.hash(
      runtimeType,
      id,
      const DeepCollectionEquality().hash(_comrades),
      countryIso3Code,
      date,
      description,
      destination,
